...
// Tightly cropped SVG of Tavoo transparent logo in olive green #4E5328
const svg = `
<svg xmlns="http://www.w3.org/2000/svg" viewBox="90 200 810 520" width="1620" height="1040">
  <g fill="#4F5328">
    <!-- T top crossbar swoosh -->
    <path d="M 110 365 C 150 270, 240 220, 445 235 C 380 262, 260 285, 185 385 C 158 420, 122 400, 110 365 Z" />
    
    <!-- T main vertical/diagonal stem -->
    <path d="M 310 250 C 255 375, 195 535, 150 660 C 140 688, 162 698, 182 668 C 222 588, 282 432, 322 300 Z" />
...
const resvg = new Resvg(svg, { fitTo: { mode: 'width', value: 1620 } });
const pngData = resvg.render().asPng();
fs.mkdirSync('public', { recursive: true });
fs.writeFileSync('public/tavoo-logo-transparent-cropped.png', pngData);
fs.writeFileSync('public/tavoo-logo.png', pngData);
console.log('Generated public/tavoo-logo-transparent-cropped.png, size:', pngData.length);
